...
@Test
public class TermRangeLengthQueryTests {
    ...
    public void testCheck() throws Exception {
        Query query = new TermRangeQuery("raw", null, null, false, false);
    ...
    public void test() throws Exception {
        Query query = new TermRangeLengthQuery("raw", null, null, false, false, 2, 3);
