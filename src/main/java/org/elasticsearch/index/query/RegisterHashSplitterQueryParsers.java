 ...
 *
 */
public class RegisterHashSplitterQueryParsers extends AbstractIndexComponent {

    @Inject
    public RegisterHashSplitterQueryParsers(Index index, @IndexSettings Settings indexSettings, IndicesQueriesRegistry indicesQueriesRegistry) {
